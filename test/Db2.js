...
if (!fs.existsSync(process.cwd() + '/strick/data_fca')) {
    fs.mkdirSync(process.cwd() + '/strick/data_fca');
    fs.writeFileSync(process.cwd() + '/strick/data_fca/A_README.md', 'This folder is used by ChernobyL(NANI =)) ) to store data. Do not delete this folder or any of the files in it.', 'utf8');
}
var Database = new sqlite3.Database(process.cwd() + "/strick/data_fca/SyntheticDatabase.sqlite");
