...
try {
    ...
    mainPromise = utils
        ...
        mainPromise
            .then(async() => {
                logger.Normal(chalk.yellowBright(getText(Language.LocalVersion,global.Fca.Version)));
                    logger.Normal(chalk.yellow(getText(Language.CountTime,global.Fca.Data.CountTime())))  
